      ...
      <div className="flex-1 bg-white rounded shadow p-6 md:mr-8">
        ...
        <div>
          <div className="flex items-center bg-blue-50 rounded-t px-4 py-2 mb-4">
            <span className="bg-blue-600 text-white rounded px-3 py-1 mr-3 font-bold">
              1
            </span>
            ...
            <div className="flex-1 mb-6 md:mb-0">
              ...
              <div className="flex items-center mb-2">
                <input
                  ...
                  className="mr-2"
                />
                <label htmlFor="guest" className="mr-6">
                  Checkout as Guest
                </label>
                <input
                  type="radio"
        ...
        <div className="space-y-4">
          <div className="flex items-center bg-gray-100 rounded px-4 py-2">
            <span className="bg-gray-400 text-white rounded px-3 py-1 mr-3 font-bold">
              2
            </span>

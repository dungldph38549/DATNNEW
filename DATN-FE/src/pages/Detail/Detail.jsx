...
const Detail = () => {
  ...
  const { data: products, isLoading: isLoadingRelated } = useQuery({
    queryKey: [
                ...
                <List
                  ...
                  renderItem={(review) => (
                    <Comment
                      ...
                      datetime={dayjs(review.createdAt).format(
                        "HH:mm DD/MM/YYYY"
                      )}
                      actions={[
                        user.login && (
                      ...
                      {(review.replies || []).map((reply, index) => (
                        <Comment
                          ...
                          author={`${reply?.userId?.name} (${
                            reply.role === "admin" ? "Shop" : "Người dùng"
                          })`}
                          content={reply.content}
                          datetime={dayjs(reply.createdAt).format(
                            "HH:mm DD/MM/YYYY"
                          )}
                        />
                      ))}

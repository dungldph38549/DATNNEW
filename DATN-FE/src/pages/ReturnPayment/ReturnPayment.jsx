        ...
        <div style={{ textAlign: 'center', marginTop: '50px' }}>
            ...
            {queryObject && (
                <>
                    ...
                    <p className='mb-2 text-lg'> 
                        Số tiền: <strong>{(Number(queryObject.vnp_Amount)/100)?.toLocaleString('vi-VN')} VND</strong>
                    </p>
                </>
            )}
            {isLoading ? (
                ...
                <div className='mb-20'>
                    ...
                    <Link to="/" className="mr-3 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Mua sắm</Link>
                    <Link to="/orders" className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Đơn hàng</Link>
                </div>
            )}
        </div>
    );

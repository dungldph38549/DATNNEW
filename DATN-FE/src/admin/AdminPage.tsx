...
const AdminPage = () => {
  ...
  const renderContent = () => {
    switch (selectedMenu) {
      ...
      default:
        return (
          <p className="text-gray-600">📋 Chọn mục bên trái để xem nội dung</p>
        );
    }
  };
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div
        className="w-[20rem] h-screen bg-white p-4 shadow-xl"
        ...
        <nav className="flex flex-col gap-2">
          <button
            ...
            className={`text-left p-3 rounded ${
              selectedMenu === "products" ? "bg-blue-100" : "hover:bg-blue-100 "
            }`}
          >
            Quản lý sản phẩm
          </button>
